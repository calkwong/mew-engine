...
VkSubmitInfo2 vkinit::submit_info(const VkCommandBufferSubmitInfo* submit_cmd_info, const VkSemaphoreSubmitInfo* signal_semaphore_info, const VkSemaphoreSubmitInfo* wait_semaphore_info)
{
	VkSubmitInfo2 info{};
...
VkPipelineShaderStageCreateInfo vkinit::pipeline_shader_stage_create_info(VkShaderStageFlagBits stage, VkShaderModule shader_module, const char* entry /*= "main"*/)
{
...
VkRenderingInfo vkinit::rendering_info(VkExtent2D extent, const VkRenderingAttachmentInfo* color_attachment, const VkRenderingAttachmentInfo* depth_attachment)
{
