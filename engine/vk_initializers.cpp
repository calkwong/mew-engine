...
VkSubmitInfo2 vkinit::submit_info(VkCommandBufferSubmitInfo* submit_cmd_info, VkSemaphoreSubmitInfo* signal_semaphore_info, VkSemaphoreSubmitInfo* wait_semaphore_info)
{
    VkSubmitInfo2 info{};
...
VkRenderingInfo vkinit::rendering_info(VkExtent2D extent, VkRenderingAttachmentInfo* color_attachment, VkRenderingAttachmentInfo* depth_attachment)
{
